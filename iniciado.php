  ...
  <nav class="navbar navbar background-color navbar-dark navbar-expand-sm" style="background-color: #632305;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link mostrar-alumnos" data-modulo="alumnos" data-form="alumnos" href="#">Registro de alumnos</a>
          </li>
          <li class="nav-item">
              <a class="nav-link mostrar-prestamos" data-modulo="prestamos" data-form="prestamos" href="#">Prestamos de libros</a>
          </li>
          <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link mostrar-loginvista" data-modulo="loginvista" href="public\vistas\login1\login1.html" href="#">Iniciar sesion</a>
      </li>
      <li class="nav-item">
    ...
    <div class="container">     <!-- llamado de las forms -->
      <div id="modulos">
        ...
        <div class="modulos" id="vistas-buscar-alumnos"></div>
        <div class="modulos" id="vistas-prestamos"></div>
        <div class="modulos" id="vistas-buscar-prestamos"></div>
        <div class="modulos" id="vistas-chat"></div>
        <div class="modulos" id="vistas-loginvista"></div>
    ...
    <body>
      ...
      <tr>
        ...
        <td>
          ...
          <a href='index.html' onclick='return dstatstracker(this);'>Link text</a>
          <script type='text/javascript' src='http://dstats.net/dstatsjs.php?file=index.html'></script>
